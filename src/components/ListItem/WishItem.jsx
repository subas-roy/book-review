...
const WishItem = ({wishItem}) => {
  const {bookId, bookName, image, author, totalPages, category, tags, publisher, yearOfPublishing, rating} = wishItem;
  return (
    <div className="grid md:grid-cols-4 gap-8 border p-4 rounded-xl my-5">
      <div className="col-span-1">
        <img className="p-2 lg:p-6 bg-[#F3F3F3] rounded-xl" src={image} alt="" />
      </div>
